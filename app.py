...
# ═══════════════════════════════════════════════════════════════════
# PRICE HISTORY (now real monthly closes):
#   S&P 500 closes: multpl.com / Yahoo Finance
#   Gold closes: LiteFinance, Trading Economics, USAGOLD reports
#   Brent closes: Trading Economics monthly data
#   10Y UST: FRED / Yahoo Finance
#   EUR/USD: real monthly closes
#   EuroStoxx 50: Trading Economics (replaced Defence ETF)
#   Note: Gold ATH $5,595.52 Jan 29 2026 confirmed multiple sources
#
# SUPPLY CHAIN SHARES (updated to reflect WTO 2025 rerouting data):
#   Vietnam: 28% (largest beneficiary of China+1 strategy)
#   India: 22% (smartphone manufacturing surge)
#   Mexico: 14% (nearshoring auto/mfg)
#   Germany: 16% (high-value EU exports)
#   Malaysia: 15% (semiconductor packaging)
#   Australia: 9% (critical minerals)
#   Japan: 5%, Saudi Arabia: 4%
# ═══════════════════════════════════════════════════════════════════
...
European Equities,5011.00,Upgrade,STOXX50 -9.5% March; 13%+ earnings growth,BUY,5
...
India,9,Smartphone exports +$15B; IT services boom; tariff-neutral,POSITIVE,OVERWEIGHT,22,6.3,Low,Low
Vietnam,9,Electronics hub; US import share gains; ASEAN exports +14%,STRONG,OVERWEIGHT,28,6.1,Low,Low
Malaysia,8,Semiconductor packaging alt; rare earth processing,POSITIVE,OVERWEIGHT,15,4.3,Low,Low
Germany,8,Fiscal expansion; defence capex; EU earnings engine,POSITIVE,OVERWEIGHT,16,1.3,Low-Med,Low
Saudi Arabia,8,Oil price upside; Vision 2030; Washington alignment,POSITIVE,OVERWEIGHT,4,4.5,Low,Medium
Japan,8,Corporate reform; wage growth; shareholder return cycle,POSITIVE,OVERWEIGHT,5,0.7,Low,Low
Australia,8,Critical minerals lithium rare earths; China alt supply,POSITIVE,OVERWEIGHT,9,2.1,Low,Low
Mexico,5,Nearshoring beneficiary; auto share gains +12pp since 2017,MIXED,NEUTRAL,14,1.5,Medium,Medium
...
RAW_HISTORY = """date,sp500,gold,brent,ust_10y,eurusd,stoxx50
2025-10-01,6735.69,2749.25,73.90,4.28,1.0936,4952.00
2025-11-01,6740.89,2736.40,72.16,4.18,1.0576,4833.00
2025-12-01,6853.03,2625.83,74.13,4.57,1.0454,4942.00
2026-01-01,6929.12,2812.35,76.49,4.54,1.0297,5160.00
2026-01-31,5595.00,4500.00,79.20,4.54,1.0420,5245.00
2026-02-01,6893.81,5060.00,84.50,4.31,1.0461,5380.00
2026-02-28,5595.00,5075.00,88.70,4.22,1.0392,5420.00
2026-03-01,6822.41,5200.00,98.70,4.27,1.0840,5502.00
2026-03-15,6495.00,5490.00,108.30,4.26,1.1350,5270.00
2026-03-31,6528.52,4703.20,118.00,4.311,1.1584,5011.00"""
...
with tabs[6]:
    ...
    metric_options = {
        ...
        "10Y UST Yield (%)":"ust_10y","EUR/USD":"eurusd","EuroStoxx 50":"stoxx50",
    }
